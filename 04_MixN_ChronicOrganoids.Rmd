...
ggsave(dotplot.multintersect.mod(m, th=0.05), filename='Data/ChronicOrganoids/DotplotOrgNDD.pdf', width=10, height=6)
...
ggsave(dotplot.multintersect.mod(m, th=0.05), filename='Data/ChronicOrganoids/DotplotOrgSFARI.pdf', width=10, height=6)
```
...
ggsave(dotplot.multintersect.mod(m, th=0.05), filename='Data/ChronicOrganoids/DotplotOrgNPD.pdf', width=10, height=6)
```
...
dotplot.multintersect.mod(m, th=0.05)
m<-multintersect(ll = MixN, ll2 = ASD,  universe = row.names(filterGenes(Total)),two.tailed = F)
dotplot.multintersect.mod(m, th=0.05)
m<-multintersect(ll = MixN, ll2 = SFARIgenes,  universe = row.names(filterGenes(Total)),two.tailed = F)
dotplot.multintersect.mod(m, th=0.05)
m<-multintersect(ll = MixN, ll2 = NeuropsychiatricDiseases,  universe = row.names(filterGenes(Total)),two.tailed = F)
dotplot.multintersect.mod(m, th=0.05)
